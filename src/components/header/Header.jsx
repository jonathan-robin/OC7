    ...
    return (
        <div className="header__container">
            <div className="container__logo" >
                <NavLink  id="link-home" className="nav--item"  to="/"></NavLink>
                ...
                <svg className="fix-svg" width="47" height="54" viewBox="0 0 47 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <svg className="fix-svg" width="41" height="49" viewBox="0 0 41 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="fix-svg" width="42" height="49" viewBox="0 0 42 49" fill="none" xmlns="http://www.w3.org/2000/svg">
